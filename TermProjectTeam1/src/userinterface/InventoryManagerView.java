...
public class InventoryManagerView extends View 
{
	...
	// GUI stuff
	private Button insertIITButton, searchIITButton, searchIIButton, doneButton, addVendorButton, searchVendorButton, addVIITButton, deleteVIITButton, getIICollectionButton;
	...
	private GridPane createFormContents()
	{
        ...
        getIICollectionButton = new Button("Inventory Items");
        getIICollectionButton.setOnAction(e -> {
        	myModel.stateChangeRequest("GetIICollection", null);
        });
		...
		btnContainer.getChildren().addAll(insertIITButton, searchIITButton, searchIIButton, addVendorButton, searchVendorButton, addVIITButton, deleteVIITButton, getIICollectionButton, doneButton);
